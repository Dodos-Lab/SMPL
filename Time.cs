...
namespace SMPL
{
	...
	/// It requires a continuous <see cref="Update"/> in order to have the correct values.
	/// </summary>
	public static class Time
	{
		...
		/// <summary>
		/// The real time clock taken from <see cref="DateTime.Now"/> and updated by <see cref="Update"/> in seconds ranged
		/// [0 - 86399]<br></br>or in clock hours ranged [12 AM, 00:00, 24:00 - 11:59:59 AM, 23:59:59].
		/// </summary>
		public static float Clock { get; private set; }
		/// <summary>
		/// The time in seconds since the last <see cref="Update"/>. This is useful for multiplying a step value against it in continuous calculations
		...
		/// <summary>
		/// The frames per second determined by the <see cref="Update"/> calls. Same as ticks per second or updates per second.
		/// </summary>
		...
		/// <summary>
		/// The seconds that have passed since the start of the game. Updated by <see cref="Update"/>.
		/// </summary>
		public static float GameClock { get; private set; }
		/// <summary>
		/// The amount of rendered frames since the start of the game. Same as amount of ticks or <see cref="Update"/> calls.
		/// </summary>
		public static uint FrameCount { get; private set; }

		/// <summary>
		/// Used for updating all <see cref="Time"/> values. Call continuously (in <see cref="Scene.OnUpdate"/> for example) to keep them correct.
		/// </summary>
